...
Say we want to join the Batting table, Master table, and Teams tables all in one query. For example, we want to see Babe Ruth's first and last name, the year, homeruns and team name.
...
Lets get the career homerun totals for players. Limit the display to just those that hit at least 600HR. Highest homerun totals at the top. First and last names, and HR total.
...
List all players with the first name Bob who averaged more than one millin dollars in salary over their career. Include last names.
